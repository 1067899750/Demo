...
public class FloatView implements View.OnTouchListener {
    ...
    private void initFloatView() {
        ...
        mPrevPositionX = mScreenWidth - getActivity().getResources().getDimensionPixelOffset(R.dimen.d70);
        mPrevPositionY = mScreenHeight * 4 / 5;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.e("FloatView", "MotionEvent.ACTION_DOWN");
                mTouchResult = true;
...
//                }
            ...
            case MotionEvent.ACTION_UP:
                Log.e("FloatView", "MotionEvent.ACTION_UP");
